...
#Read and write a comma separated value file. This is a special case
#of read.table/ write.table.
...
saved_file <- "week5/assignments/airline_safety.csv"
download.file(
    url = "https://raw.githubusercontent.com/fivethirtyeight/data/master/airline-safety/airline-safety.csv",
    destfile = saved_file
    )
#Then you need to name your dataset
airline_safety <- read.csv(saved_file)


#TASK: take a look at the airline safety data.
print(head(airline_safety))
...
write.csv(mysample, "week5/assignments/my_sample.csv")
...
# Note how the dataset name is not repeated in each function
piping <- mysample %>%
...
# Keep the original as ground truth:
mysample2 <- mysample
